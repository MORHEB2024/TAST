...
async def get_thumb(videoid):
    ...
    title_font = ImageFont.truetype("ZeMusic/assets/font.ttf", 45)
    ...
    fontsize = 70  # حجم الخط الجديد

    draw.text((text_x_position, 180), "SOURCE SNiPER", fill=(255, 255, 255), font=ImageFont.truetype("ZeMusic/assets/font.ttf", fontsize))
    draw.text((text_x_position, 230), "", fill=(255, 255, 255), font=title_font)
    ...
    play_icons = Image.open("ZeMusic/assets/play_icons.png")
